<%-- 
    Document   : add_flight
    Created on : Jun 7, 2016, 6:32:00 PM
    Author     : Het
--%>
...
<div class="main">
    ...
    <nav>
     ...
     <li><a href="admin_login.html"><span><span>Admin Site</span></span></a></li>
       <li id="menu_active"><a href="emplogin.jsp"><span><span>Employee Login</span></span></a></li>
      </ul>
    </nav>
  </header>
    <div class="dropdown">
  ...
  <div id="myDropdown" class="dropdown-content">
    ...
    <a href="empFlight.jsp">See Flight</a>
  ...
  <!-- / header -->
		<span href="#" class="button" id="toggle-login">Add Flight</span>

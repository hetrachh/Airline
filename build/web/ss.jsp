<%-- 
    Document   : del_schedule
    Created on : Jun 8, 2016, 4:06:26 PM
    Author     : Het
--%>
...
<div class="main">
  ...
  <div id="myDropdown" class="dropdown-content">
    ...
    <a href="SearchSchedule.jsp">Search Schedule</a>
		...
		<span href="#" class="button" id="toggle-login">Search Schedule</span>

		<div id="login">
		  <div id="triangle"></div>
		  <!--<h1>Log in</h1>-->
                  <form method ="post"  action="sr.jsp" >
                      <input type="checkbox" name="Economy" value="1"/>Economy Class
                      <input type="checkbox" name="Business" value="1"/>Business Class
                      <input type="checkbox" name="First" value="1"/>First Class

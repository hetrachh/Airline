<%-- 
    Document   : update_off
    Created on : Jun 10, 2016, 3:33:32 PM
    Author     : Het
--%>
...
<div class="main">
      ...
      <nav id="top_nav">
        <ul>
         ...
         <!-- <li><a href="#" class="nav2">Sitemap</a></li>-->
          <li><a href="logout" class="nav2">Log Out</a></li>
  ...
  <div>
  <!-- / header -->
		<span href="#" class="button" id="toggle-login">Update Offer</span>

		<div id="login">
		  <div id="triangle"></div>
		  <!--<h1>Log in</h1>-->
                  <form method ="post"  action="update_offer.jsp" >
			...
			<input type="text" name="dep_city" placeholder="Departure City" />

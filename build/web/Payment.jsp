												...
												<div class="transaction">
													<div class="tab-form-left user-form">
														<h5>EXPIRATION</h5>
															<ul>
																<li>
																	<input type="number" name="expdate" class="text_box" type="text" value="6" min="1" />	
																</li>
																<li>
																	<input type="number" name="expyear" class="text_box" type="text" value="1988" min="1" />	
																</li>
									...
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-3">	
										<div class="payment-info">
											...
											<h3 class="pay-title">Dedit Card Info</h3>
                                                                                        <form action="debitpay.jsp" method="get">
												<div class="tab-for">				
													<h5>NAME ON CARD</h5>
														<input type="text" name="cname">
													<h5>CARD NUMBER</h5>													
														<input class="pay-logo" name="cnum" type="text">
                                                                                                </div>	<input type="hidden" name="user" value="<%=user%>"/>
												...
												<div class="transaction">
													<div class="tab-form-left user-form">
														<h5>EXPIRATION</h5>
															<ul>
																<li>
																	<input type="number" name="emonth" class="text_box" type="text" value="6" min="1" />	
																</li>
																<li>
																	<input type="number" name="eyear" class="text_box" type="text" value="1988" min="1" />	
																</li>

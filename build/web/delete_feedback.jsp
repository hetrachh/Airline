<%-- 
    ...
    Created on : Jun 9, 2016, 3:12:22 PM
    Author     : Het
--%>
...
<div class="main">
    ...
    <div class="wrapper">
      ...
      <nav id="top_nav">
        <ul>
          <li><a href="sh_feedback.jsp" class="nav1">Home</a></li>
    ...
    <nav>
      <ul id="menu">
        ...
        <li id="menu_active"><a href="sh_feedback.jsp" class="end"><span><span>FeedBack</span></span></a></li>
        ...
        <li><a href="seecontacts.jsp"><span><span>Contacts</span></span></a></li>
                      ...
                      <div class="dropdown">
  <button onclick="myFunction()" class="dropbtn">FeedBack</button>
  <div id="myDropdown" class="dropdown-content">
  <!--  <a href="#">Add User</a>
    <a href="#">Update User</a>-->
  <a href="delete_feedback.jsp">Delete FeedBack</a>
    
  </div>
</div>
  <!-- / header -->
		<span href="#" class="button" id="toggle-login">Delete Feedback</span>

		<div id="login">
		  <div id="triangle"></div>
		  <!--<h1>Log in</h1>-->
                  <form method ="post"  action="del_feedback.jsp" >
                      <input type="text" name="ticketnum" placeholder="Ticket Number" />

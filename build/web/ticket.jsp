...
<div class="main">
  ...
  <header>
    <div class="wrapper">
      ...
      <%String name = (String) session.getAttribute("to"); %>
		        <strong>Welcome To</strong>
                        <u><b><%out.println(name);
                                String name1=request.getParameter("name");%></b></u>
    ...
    <nav>
      <ul id="menu">
        ...
        <li id="menu_active"><a href="ticket.jsp"><span><span>Book</span></span></a></li>
  ...
  <div id="myDropdown" class="dropdown-content">
    ...
    <a href="update_ticket1.jsp">Update Ticket</a>
    <a href="cancle_ticket1.jsp">Cancellation Ticket</a>
...
SELECT * from book where name="<%=name1%>";
</sql:query>
<br>
<div class="schfont">Tickets</div><br>

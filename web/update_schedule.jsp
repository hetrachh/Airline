<%-- 
    Document   : update_schedule
    Created on : Jun 8, 2016, 3:58:03 PM
    Author     : Het
--%>
...
<div class="main">
  ...
  <!-- / header -->
		<span href="#" class="button" id="toggle-login">Update Schedule</span>

		<div id="login">
		  <div id="triangle"></div>
		  <!--<h1>Log in</h1>-->
                  <form method ="post"  action="update_sch.jsp" >

<%-- 
    ...
    Created on : Jun 8, 2016, 3:50:45 PM
    Author     : Het
--%>
...
<div class="main">
    ...
    <div class="wrapper">
      ...
      <nav id="top_nav">
        <ul>
          <li><a href="schedule.jsp" class="nav1">Home</a></li>
  ...
  <div id="myDropdown" class="dropdown-content">
    ...
    <a href="ss.jsp">Search Class</a>
  </div>
</div>
  <!-- / header -->
		<span href="#" class="button" id="toggle-login">Add Schedule</span>

		<div id="login">
		  <div id="triangle"></div>
		  <!--<h1>Log in</h1>-->
                  <form method ="post"  action="add_sch.jsp" >
			...
			<input type="text" name="source" placeholder="Source" />
                        ...
                        <input type="text" name="class1" placeholder="Economy Class Price">
                        <input type="text" name="class1cap" placeholder="Economy Class Capacity"/>
                        <input type="text"  name="class2" placeholder="Business Class Price"/>
                        <input type="text"  name="class2cap" placeholder="Business Class Capacity"/>
                        <input type="text"  name="class3" placeholder="First Class Price"/>
                        <input type="text"  name="class3cap" placeholder="First Class capacity"/>

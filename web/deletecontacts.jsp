...
<div class="main">
    ...
    <nav>
     ...
     <!--   <li ><a href="add.html"><span><span>Add Flight</span></span></a></li>
        ...
        <li id="menu_active"><a href="seecontacts.jsp"><span><span>Contacts</span></span></a></li>
      </ul>
    </nav>
  </header>
  <!-- / header -->
  ...
  <div id="myDropdown" class="dropdown-content">
    <a href="deletecontacts.jsp">Delete contacts</a>
  </div>
</div>
		<span href="#" class="button" id="toggle-login">Delete Schedule</span>

		<div id="login">
		  <div id="triangle"></div>
		  <!--<h1>Log in</h1>-->
                  <form method ="post"  action="delcon.jsp" >

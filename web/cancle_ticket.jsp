<%-- 
    Document   : cancle_ticket
    Created on : Jun 20, 2016, 3:30:22 PM
    Author     : Het
--%>
...
<div class="dropdown">
  ...
  <div id="myDropdown" class="dropdown-content">
    <a href="update_ticket.jsp">Update Booking</a>
    <a href="cancle_ticket.jsp">Delete Booking</a>
    <a href="sh_book.jsp">Show Booking</a>
     </div>
</div>
		<span href="#" class="button" id="toggle-login">Delete Booking</span>

		<div id="login">
		  <div id="triangle"></div>
		  <!--<h1>Log in</h1>-->
                  <form method ="post"  action="delbook.jsp" >

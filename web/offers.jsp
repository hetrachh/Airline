...
<div class="main">
  ...
  <div>
  <!-- / header -->
		<span href="#" class="button" id="toggle-login">Add Offer</span>

		<div id="login">
		  <div id="triangle"></div>
		  <!--<h1>Log in</h1>-->
                  <form method ="post" action="jay_hind" enctype="multipart/form-data" >
                      <input type="text" name="fligt_id" placeholder="Flight No." />
                      ...
                      <input type="text" name="dep_city" placeholder="Source"/>
                      <input type="text" name="arr_city" placeholder="Destintion"/>
